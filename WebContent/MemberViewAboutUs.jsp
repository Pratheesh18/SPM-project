...
<html lang="en">
  <head>
    <title>Apple Event Planners</title>
    <meta charset="utf-8">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="home/index.html"><span>Apple</span>EVENT PLANNERS</a>
    			...
    			<div class="col-md-6 col-lg-6 pl-md-5 py-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		            ...
		            <ul class="about-info mt-4 px-md-0 px-2">
		            	<li class="d-flex"><span>Name:</span> <span>Apple Event Planners</span></li>
		            	<li class="d-flex"><span>Since:</span> <span>Sep 1, 2019</span></li>
		            	<li class="d-flex"><span>Location:</span> <span>Kandy</span></li>
		            	<li class="d-flex"><span>Zip code:</span> <span>20000</span></li>
		            	<li class="d-flex"><span>Email:</span> <span>Appleplanners@gmail.com</span></li>
		            	<li class="d-flex"><span>Phone: </span> <span>0112457357</span></li>
		            </ul>
		          </div>
		        </div>
